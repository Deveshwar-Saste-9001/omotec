...
//        holder.student_class.setText(student_List.get(position).getStudent_Section());
        ...
        holder.setData((position+1),name,stud_class,absent);
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        void item_clicked(@NonNull View itemView,int i,String name, String classes, boolean ab){
            if (student_absent.getText()=="A"){
                List_view_model model=new List_view_model(i+1,name,classes,false);
                student_List.set(i,model);
                ...
                List_view_model model=new List_view_model(i+1,name,classes,true);
                student_List.set(i,model);
